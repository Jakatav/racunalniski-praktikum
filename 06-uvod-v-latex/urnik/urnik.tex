...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. 
S \(k_n\) označimo število
...
\begin{enumerate}
   ...
   \item Za vse proste termine \(predavalnica_j\) izračunamo ceno vstavljanja
   ...
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo \(srecanja_i\)
...
\end{enumerate}
\subsection{Optimizacijske metod}
